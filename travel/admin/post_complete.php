                                ...
                                <div class="col-lg-12">
                                    <?php 
                                        ...
                                        if (isset($_POST["upload_post"])) {
                                          ...
                                          $sql = "INSERT INTO posts (title, description, price, address, city_id, image)  VALUES ('$title', '$description', '$price', '$address', $city_id, '$image')";

                                    

                                          if($conn->query($sql) === TRUE) {
                                            echo "<br> tao post thanh cong";
                                          } else {
                                            echo "<br> error post" . $conn->error;
                                          }
                                        }
                                    ?>
                                </div>
