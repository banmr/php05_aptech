...
<?php require('frontend/views/common/slider.php'); ?>
	        ...
	        <div class="our-listing owl-carousel">
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_1.jpg" alt="destination 1">
	                </div> <!-- /.list-thumb -->
	            ...
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_2.jpg" alt="destination 2">
	                </div> <!-- /.list-thumb -->
	                <div class="list-content">
	            ...
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_3.jpg" alt="destination 3">
	                </div> <!-- /.list-thumb -->
	                <div class="list-content">
	            ...
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_4.jpg" alt="destination 4">
	                </div> <!-- /.list-thumb -->
	                <div class="list-content">
	            ...
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_5.jpg" alt="destination 5">
	                </div> <!-- /.list-thumb -->
	                <div class="list-content">
	            ...
	            <div class="list-item">
	                <div class="list-thumb">
	                    ...
	                    <img src="webroot/images/destination_6.jpg" alt="destination 6">
	                </div> <!-- /.list-thumb -->
	                <div class="list-content">
